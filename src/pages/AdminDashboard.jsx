  ...
  return (
    <div className="min-h-screen bg-white px-6 md:px-12 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex gap-2 mb-8 border-b border-brand-dark/10">
          <button onClick={() => setTab("inquiries")} className={`px-4 py-2 text-sm font-medium border-b-2 transition ${tab === "inquiries" ? "border-brand-dark text-brand-dark" : "border-transparent text-brand-dark/50"}`}>Inquiries</button>
          <button onClick={() => setTab("content")} className={`px-4 py-2 text-sm font-medium border-b-2 transition ${tab === "content" ? "border-brand-dark text-brand-dark" : "border-transparent text-brand-dark/50"}`}>Edit My Content</button>
        </div>
        ...
        {tab === "inquiries" && (
          <>
            ...
            <div className="space-y-4">
              {inquiries.map((inq) => (
                <div key={inq.id} className="p-5 rounded-xl border border-brand-dark/10">
