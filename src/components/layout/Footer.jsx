    ...
    <footer className="px-6 md:px-12 py-16 bg-brand-dark text-white border-t border-white/10">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          ...
          <p className="mt-2 text-sm text-white/60">UX/UI Designer turning complex ideas into simple digital experiences.</p>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-white/60">
            <li className="flex items-center gap-2"><Mail size={14} /> alphonce@example.com</li>
